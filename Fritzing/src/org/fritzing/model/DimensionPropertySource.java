...
static{
	PropertyDescriptor widthProp =
		new TextPropertyDescriptor(ID_WIDTH,
			FritzingMessages.DimensionPropertySource_Property_Width_Label);
	widthProp.setValidator(FritzingNumberCellEditorValidator.instance());
	PropertyDescriptor heightProp = 
		new TextPropertyDescriptor(ID_HEIGHT,
			FritzingMessages.DimensionPropertySource_Property_Height_Label);
	heightProp.setValidator(FritzingNumberCellEditorValidator.instance());
