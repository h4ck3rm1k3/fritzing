...
public FritzingRuler(boolean isHorizontal) {
	this(isHorizontal, RulerProvider.UNIT_PIXELS);
}

public FritzingRuler(boolean isHorizontal, int unit) {
	horizontal = isHorizontal;
	setUnit(unit);
}

public void addGuide(FritzingGuide guide) {
...
public void removeGuide(FritzingGuide guide) {
