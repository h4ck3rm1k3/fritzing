...
static{
	PropertyDescriptor pValueProp = new TextPropertyDescriptor(P_VALUE, 
			FritzingMessages.PropertyDescriptor_LED_Value);
	pValueProp.setValidator(FritzingNumberCellEditorValidator.instance());
	if(descriptors!=null){
...
public String toString() {
	return FritzingMessages.LED_LabelText + " #" + getID() //$NON-NLS-1$
	       + " " + FritzingMessages.PropertyDescriptor_LED_Value //$NON-NLS-1$
	       + "=" + getValue();    //$NON-NLS-1$
}
