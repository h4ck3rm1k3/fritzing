...
static{
	PropertyDescriptor xProp =
		new TextPropertyDescriptor(ID_XPOS,
			FritzingMessages.LocationPropertySource_Property_X_Label);
	xProp.setValidator(FritzingNumberCellEditorValidator.instance());
	PropertyDescriptor yProp = 
		new TextPropertyDescriptor(ID_YPOS,
			FritzingMessages.LocationPropertySource_Property_Y_Label);
	yProp.setValidator(FritzingNumberCellEditorValidator.instance());
