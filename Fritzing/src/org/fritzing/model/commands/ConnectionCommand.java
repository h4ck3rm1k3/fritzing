...
protected FritzingSubpart oldSource;
protected String oldSourceTerminal;
protected FritzingSubpart oldTarget;
protected String oldTargetTerminal;
protected FritzingSubpart source;
protected String sourceTerminal;
protected FritzingSubpart target; 
protected String targetTerminal; 
protected Wire wire;

public ConnectionCommand() {
	super(FritzingMessages.ConnectionCommand_Label);
}
...
public String getLabel() {
	return FritzingMessages.ConnectionCommand_Description;
}

public FritzingSubpart getSource() {
	return source;
}
...
public FritzingSubpart getTarget() {
	return target;
}
...
public void setSource(FritzingSubpart newSource) {
	source = newSource;
}
...
public void setTarget(FritzingSubpart newTarget) {
	target = newTarget;
}
