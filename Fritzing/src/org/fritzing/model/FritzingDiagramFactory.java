...
public class FritzingDiagramFactory {

FritzingDiagram root;

protected static void connect(FritzingSubpart e1, String t1, FritzingSubpart e2, String t2) {
	Wire wire = new Wire();
	wire.setSource(e1);
...
public static Object createLargeModel() {
	FritzingDiagram root = new FritzingDiagram();
