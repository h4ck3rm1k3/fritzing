 ...
 */
abstract public class FritzingEditPart
...
protected void createEditPolicies(){
	installEditPolicy(EditPolicy.COMPONENT_ROLE, new FritzingElementEditPolicy());
	installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new FritzingNodeEditPolicy());
}
...
/**
 * Returns the model associated with this as a FritzingSubPart.
 *
 * @return  The model of this as a FritzingSubPart.
 */
...
protected List getModelSourceConnections(){
	return getFritzingSubpart().getSourceConnections();
}
...
protected List getModelTargetConnections(){
	return getFritzingSubpart().getTargetConnections();
}
...
public void propertyChange(PropertyChangeEvent evt){
	...
	if (FritzingSubpart.CHILDREN.equals(prop)) {
	...
	else if (FritzingSubpart.INPUTS.equals(prop))
		refreshTargetConnections();
	else if (FritzingSubpart.OUTPUTS.equals(prop))
		refreshSourceConnections();
	else if (prop.equals(FritzingSubpart.ID_SIZE) || prop.equals(FritzingSubpart.ID_LOCATION))
		refreshVisuals();
}
...
protected void refreshVisuals() {
	Point loc = getFritzingSubpart().getLocation();
	Dimension size= getFritzingSubpart().getSize();
