...
/**
 * Holds all other FritzingEditParts under this. It is 
 * activated by FritzingEditorPart, to hold the entire
 * model. It is sort of a blank board where all 
 * other EditParts get added.
 */
public class FritzingDiagramEditPart
...
protected AccessibleEditPart createAccessible() {
	return new AccessibleGraphicalEditPart(){
		public void getName(AccessibleEvent e) {
			e.result = FritzingMessages.FritzingDiagram_LabelText;
		}
	};
}
...
public void propertyChange(PropertyChangeEvent evt) {
	if (FritzingDiagram.ID_ROUTER.equals(evt.getPropertyName()))
		refreshVisuals();
	else
...
protected void refreshVisuals() {
	...
	if (getFritzingDiagram().getConnectionRouter().equals(FritzingDiagram.ROUTER_MANUAL)) {
		AutomaticRouter router = new FanRouter();
		router.setNextRouter(new BendpointConnectionRouter());
		cLayer.setConnectionRouter(router);
	} else if (getFritzingDiagram().getConnectionRouter().equals(FritzingDiagram.ROUTER_MANHATTAN))
