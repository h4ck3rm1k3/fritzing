...
public class FritzingContextMenuProvider
	extends org.eclipse.gef.ContextMenuProvider
{

private ActionRegistry actionRegistry;

public FritzingContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
	super(viewer);
...
public void buildContextMenu(IMenuManager manager) {
	...
	// Alignment Actions
	MenuManager submenu = new MenuManager(FritzingMessages.AlignmentAction_AlignSubmenu_ActionLabelText);
