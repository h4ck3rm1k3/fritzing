...
public class FritzingFlowBorder 
...
public FritzingFlowBorder() {}

public FritzingFlowBorder(int width) {
...
public void paint(IFigure figure, Graphics graphics, Insets insets) {
	...
	graphics.setBackgroundColor(FritzingColorConstants.fritzingGreen);
