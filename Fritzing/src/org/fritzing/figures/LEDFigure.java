...
protected void paintFigure(Graphics g) {
	...
	g.setBackgroundColor(FritzingColorConstants.fritzingGreen);
	g.setForegroundColor(FritzingColorConstants.connectorGreen);
	...
	// Draw the connectors
	g.setForegroundColor(FritzingColorConstants.connectorGreen);
	g.setBackgroundColor(FritzingColorConstants.connectorGreen);
	for (int i = 0; i < 4; i++) {
	...
	// Draw the display
	g.setBackgroundColor(FritzingColorConstants.fritzingHighlight);
