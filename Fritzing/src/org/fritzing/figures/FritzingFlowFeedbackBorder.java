...
public class FritzingFlowFeedbackBorder 
	extends FritzingFlowBorder
{

public FritzingFlowFeedbackBorder() {}

public FritzingFlowFeedbackBorder(int width) {
	super(width);
}

public void paint(IFigure figure, Graphics graphics, Insets insets) {
	graphics.setForegroundColor(ColorConstants.white);	
	graphics.setBackgroundColor(FritzingColorConstants.ghostFillColor);
