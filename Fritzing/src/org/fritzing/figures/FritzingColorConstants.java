 ...
 *******************************************************************************/
package org.fritzing.figures;

import org.eclipse.swt.graphics.Color;

public interface FritzingColorConstants
{
...
public final static Color fritzingGreen = new Color(null, 123,174,148);
public final static Color fritzingHighlight = new Color(null,66,166,115);
public final static Color connectorGreen = new Color(null,0,69,40);
public final static Color fritzingBackgroundBlue = new Color(null, 200, 200, 240);
