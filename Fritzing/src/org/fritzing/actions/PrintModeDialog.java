...
protected void configureShell(Shell newShell) {
	newShell.setText(FritzingMessages.PrintDialog_Title);
...
protected Control createDialogArea(Composite parent) {
	...
	tile.setText(FritzingMessages.PrintDialog_Tile);
	tile.setSelection(true);
	
	fitPage = new Button(composite, SWT.RADIO);
	fitPage.setText(FritzingMessages.PrintDialog_Page);

	fitWidth = new Button(composite, SWT.RADIO);
	fitWidth.setText(FritzingMessages.PrintDialog_Width);

	fitHeight = new Button(composite, SWT.RADIO);
	fitHeight.setText(FritzingMessages.PrintDialog_Height);
