 ...
 * @author Eric Bordeau
 */
public class FritzingPasteTemplateAction extends PasteTemplateAction {

/**
 * Constructor for FritzingPasteTemplateAction.
 * @param editor
 */
public FritzingPasteTemplateAction(IEditorPart editor) {
	super(editor);
}
