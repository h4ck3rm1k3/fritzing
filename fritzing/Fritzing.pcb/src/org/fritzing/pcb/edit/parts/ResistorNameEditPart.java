...
import org.fritzing.pcb.edit.policies.FritzingTextSelectionEditPolicy;
import org.fritzing.pcb.part.FritzingVisualIDRegistry;
import org.fritzing.pcb.providers.FritzingElementTypes;
import org.fritzing.pcb.providers.FritzingParserProvider;

/**
 * @generated
 */
public class ResistorNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FritzingVisualIDRegistry
						.getType(org.fritzing.pcb.edit.parts.ResistorNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ResistorNameEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof FritzingTextSelectionEditPolicy) {
			((FritzingTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FritzingParserProvider.HintAdapter(
					FritzingElementTypes.Resistor_2002, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), FritzingEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ResistorNameFigure();
	}

	/**
	 * @generated
	 */
	public class ResistorNameFigure extends WrapLabel {

		/**
		 * @generated
		 */
		public ResistorNameFigure() {
			this.setText("");
