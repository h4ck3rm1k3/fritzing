 ...
 */
package org.fritzing.fritzing.diagram.expressions;
 ...
 * @generated
 */
public abstract class FritzingAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(FritzingDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected FritzingAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	protected FritzingAbstractExpression(String body, EClassifier context) {
		this.body = body;
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = FritzingDiagramEditorPlugin.ID;
