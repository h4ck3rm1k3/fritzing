...
import org.fritzing.fritzing.diagram.part.ValidationMarker;

/**
 * @generated
 */
public class FritzingValidationDecoratorProvider extends AbstractProvider
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof FritzingDiagramEditor) {
	...
	public static class StatusDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			ValidationMarker[] markers = ValidationMarker.getMarkers(editPart
					.getViewer(), viewId);
