 ...
 * @generated
 */
public class TrackNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FritzingVisualIDRegistry
						.getType(org.fritzing.fritzing.diagram.edit.parts.TrackNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public TrackNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FritzingParserProvider.HintAdapter(
					FritzingElementTypes.Track_4002, getParserElement(),
					parserHint);
