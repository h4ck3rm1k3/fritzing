 ...
 * @generated NOT
 */
public class PowerTransistorEditPart extends PartEditPart {
	...
	public PowerTransistorEditPart(View view) {
		super(view);
		partLoader = PartLoaderRegistry.getInstance().get("libraries/core/powertransistor/partdescription.xml");   
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PowerTransistorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PowerTransistorCanonicalEditPolicy());
	 ...
	 * @generated
	 */
	public PowerTransistorFigure getPrimaryShape() {
		return (PowerTransistorFigure) primaryShape;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FritzingVisualIDRegistry
				.getType(PowerTransistorNameEditPart.VISUAL_ID));
	}
	...
	public class PowerTransistorFigure extends PartFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigurePowerTransistorNameFigure;
		...
		protected void createContents() {
			...
			fFigurePowerTransistorNameFigure
					.setFont(FFIGUREPOWERTRANSISTORNAMEFIGURE_FONT);

			this.add(fFigurePowerTransistorNameFigure);
		 ...
		 * @generated
		 */
		public WrapLabel getFigurePowerTransistorNameFigure() {
			return fFigurePowerTransistorNameFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREPOWERTRANSISTORNAMEFIGURE_FONT = new Font(Display
			.getCurrent(),
