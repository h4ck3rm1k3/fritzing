 ...
 * @generated
 */
public class ModuleIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModuleIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FritzingParserProvider.HintAdapter(
					FritzingElementTypes.Module_2001, getParserElement(),
					parserHint);
