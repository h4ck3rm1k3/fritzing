 ...
 * @generated
 */
public class TransistorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransistorNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FritzingParserProvider.HintAdapter(
					FritzingElementTypes.Transistor_2009, getParserElement(),
					parserHint);
