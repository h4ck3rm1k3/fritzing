...
public class ArduinoItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arduino_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arduino_type_feature", "_UI_Arduino_type"),
				 FritzingPackage.Literals.ARDUINO__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Arduino.class)) {
			case FritzingPackage.ARDUINO__TYPE:
