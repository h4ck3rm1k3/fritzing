...
public abstract class CompositeImpl extends PartImpl implements Composite {
	...
	public EList<Part> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<Part>(Part.class, this, FritzingPackage.COMPOSITE__PARTS);
		}
		return parts;
	}
	...
	public EList<Wire> getWires() {
		if (wires == null) {
			wires = new EObjectContainmentEList<Wire>(Wire.class, this, FritzingPackage.COMPOSITE__WIRES);
		}
		return wires;
	}
