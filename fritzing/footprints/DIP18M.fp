...
Element(0x00 "Dual in-line package, medium wide (400 mil)" "" "DIP18M" 270 100 3 100 0x00)
(
	...
	Pin(450 850 60 28 "10" 0x01)
	Pin(450 750 60 28 "11" 0x01)
	Pin(450 650 60 28 "12" 0x01)
	Pin(450 550 60 28 "13" 0x01)
	Pin(450 450 60 28 "14" 0x01)
	Pin(450 350 60 28 "15" 0x01)
	Pin(450 250 60 28 "16" 0x01)
	Pin(450 150 60 28 "17" 0x01)
	Pin(450 50 60 28 "18" 0x01)
	
	ElementLine(0 0 0 900 10)
	ElementLine(0 900 500 900 10)
	ElementLine(500 900 500 0 10)
