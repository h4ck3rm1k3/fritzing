...
protected:
	...
	void prepDeleteProps(ItemBase * itemBase, long id, bool isDelete, QUndoCommand * parentCommand);
	void prepDeleteOtherProps(ItemBase * itemBase, long id, bool isDelete, QUndoCommand * parentCommand);
