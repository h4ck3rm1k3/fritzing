...
void BreadboardSketchWidget::addDefaultParts() {
	...
	m_addedDefaultPart = addItem(paletteModel()->retrieveModelPart(ModuleIDNames::FullPlusBreadboardModuleIDName), defaultViewLayerSpec(), BaseCommand::CrossView, viewGeometry, newID, -1, NULL, NULL);
