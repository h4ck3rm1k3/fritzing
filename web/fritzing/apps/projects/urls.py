...
urlpatterns = patterns('',
    ...
    url(r'^by-tag/(?P<tag>.*)/$', overview, name='projects-by-tag'),
    url(r'^by-category/(?P<category>.*)/$', overview, name='projects-by-category'),
    url(r'^by-difficulty/(?P<difficulty>.*)/$', overview, name='projects-by-difficulty'),
)
